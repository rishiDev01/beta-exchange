    ...
    return (
      <div className="bg-white shadow rounded-lg p-6">
        <h2 className="text-xl font-bold mb-4 flex items-center">
          <Briefcase className="mr-2 text-blue-600" /> Holdings
        </h2>
  ...
  return (
    <div className="bg-white shadow rounded-lg p-4 sm:p-6">
      <h2 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 flex items-center">
        <Briefcase className="mr-2 text-blue-600 h-5 w-5 sm:h-6 sm:w-6" /> Holdings
      </h2>
      <div className="overflow-x-auto -mx-4 sm:mx-0">
        <div className="inline-block min-w-full align-middle">
          <table className="min-w-full divide-y divide-gray-200">
            <thead>
              <tr className="text-left text-[10px] sm:text-xs font-semibold text-gray-500 uppercase tracking-wider">
