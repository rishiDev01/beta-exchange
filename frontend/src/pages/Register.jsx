      ...
      <div className="flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-12">
        <div className="max-w-md w-full mx-auto">
          <div className="mb-10 text-center lg:text-left">
            ...
            <h2 className="text-4xl font-black text-gray-900 dark:text-white mb-2 tracking-tight">Create account</h2>
            <p className="text-gray-500 dark:text-gray-400 font-medium">Start your trading journey with us today.</p>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-500 dark:text-gray-400 font-medium">
              ...
              <Link to="/login" className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-bold underline underline-offset-4 transition-all">
                Sign in
              </Link>
            </p>
          </div>
        ...
        <div className="max-w-lg w-full relative z-10 text-center">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/10 text-left">
              ...
              <p className="text-blue-100 dark:text-blue-200 text-sm font-medium">99.9% uptime and lightning fast execution.</p>
            </div>
            <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/10 text-left">
              <BarChart2 className="h-8 w-8 mb-4 text-blue-200 dark:text-blue-300" />
              <h4 className="font-bold text-xl mb-1">Global</h4>
              <p className="text-blue-100 dark:text-blue-200 text-sm font-medium">Trade stocks, crypto, and forex from one place.</p>
            </div>
          </div>
        </div>
