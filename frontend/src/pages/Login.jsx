        ...
        <div className="max-w-lg w-full relative z-10 text-center">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/10 text-left">
              ...
              <p className="text-blue-100 text-sm font-medium">Military grade encryption for your assets.</p>
            </div>
            <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/10 text-left">
              <BarChart2 className="h-8 w-8 mb-4 text-blue-200" />
              <h4 className="font-bold text-xl mb-1">Analytical</h4>
              <p className="text-blue-100 text-sm font-medium">Advanced charting and real-time insights.</p>
            </div>
          </div>
        </div>
